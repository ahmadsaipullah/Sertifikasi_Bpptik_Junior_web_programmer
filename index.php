...
$dataDaerah = ['Jakarta', 'Bogor', 'Depok', 'Tangerang', 'Bekasi'];
...
<body>
	...
	if (isset($_POST['Pesan'])) {
		...
		$lokasi = $dataPesanan['lokasi'];
		function ongkosKirim($lokasi)
		{
			if ($lokasi === "Bogor") {
				return "10000";
			} else if ($lokasi === "Tangerang") {
				return "5000";
			} else {
				return "0";
			}
		...
		function totalTagihan($ongkir, $tagihanAwal)
		{
			$total = $tagihanAwal + $ongkir;
			return $total;
		}

		$totalTagihan = totalTagihan($ongkir, $tagihanAwal);
